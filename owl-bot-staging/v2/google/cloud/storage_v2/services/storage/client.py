...
class StorageClient(metaclass=StorageClientMeta):
    ...
    def __init__(self, *,
            ...
            transport: Optional[Union[str, StorageTransport, Callable[..., StorageTransport]]] = None,
    ...
    def delete_bucket(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.DeleteBucketRequest, dict]):
    ...
    def get_bucket(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.GetBucketRequest, dict]):
    ...
    def create_bucket(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.CreateBucketRequest, dict]):
    ...
    def list_buckets(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.ListBucketsRequest, dict]):
        ...
        Returns:
            google.cloud.storage_v2.services.storage.pagers.ListBucketsPager:
    ...
    def lock_bucket_retention_policy(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.LockBucketRetentionPolicyRequest, dict]):
    ...
    def update_bucket(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.UpdateBucketRequest, dict]):
    ...
    def compose_object(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.ComposeObjectRequest, dict]):
    ...
    def delete_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.DeleteObjectRequest, dict]):
    ...
    def restore_object(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.RestoreObjectRequest, dict]):
    ...
    def cancel_resumable_write(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.CancelResumableWriteRequest, dict]):
    ...
    def get_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.GetObjectRequest, dict]):
    ...
    def read_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.ReadObjectRequest, dict]):
        ...
        Returns:
            Iterable[google.cloud.storage_v2.types.ReadObjectResponse]:
    ...
    def bidi_read_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            requests (Iterator[google.cloud.storage_v2.types.BidiReadObjectRequest]):
        ...
        Returns:
            Iterable[google.cloud.storage_v2.types.BidiReadObjectResponse]:
    ...
    def update_object(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.UpdateObjectRequest, dict]):
    ...
    def write_object(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            requests (Iterator[google.cloud.storage_v2.types.WriteObjectRequest]):
    ...
    def bidi_write_object(self,
        ...
        Args:
            requests (Iterator[google.cloud.storage_v2.types.BidiWriteObjectRequest]):
        ...
        Returns:
            Iterable[google.cloud.storage_v2.types.BidiWriteObjectResponse]:
    ...
    def list_objects(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.ListObjectsRequest, dict]):
        ...
        Returns:
            google.cloud.storage_v2.services.storage.pagers.ListObjectsPager:
                The result of a call to
                Objects.ListObjects
                Iterating over this object will yield
                results and resolve additional pages
    ...
    def rewrite_object(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.RewriteObjectRequest, dict]):
    ...
    def start_resumable_write(self,
        ...
        **IAM Permissions**:
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.StartResumableWriteRequest, dict]):
    ...
    def query_write_status(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.QueryWriteStatusRequest, dict]):
    ...
    def move_object(self,
        ...
        Args:
            request (Union[google.cloud.storage_v2.types.MoveObjectRequest, dict]):
