...
def test__get_client_cert_source():
    ...
    assert StorageClient._get_client_cert_source(mock_provided_cert_source, False) is None
    assert StorageClient._get_client_cert_source(mock_provided_cert_source, True) == mock_provided_cert_source

    with mock.patch('google.auth.transport.mtls.has_default_client_cert_source', return_value=True):
        with mock.patch('google.auth.transport.mtls.default_client_cert_source', return_value=mock_default_cert_source):
            assert StorageClient._get_client_cert_source(None, True) is mock_default_cert_source
            assert StorageClient._get_client_cert_source(mock_provided_cert_source, "true") is mock_provided_cert_source

@mock.patch.object(StorageClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageClient))
@mock.patch.object(StorageAsyncClient, "_DEFAULT_ENDPOINT_TEMPLATE", modify_default_endpoint_template(StorageAsyncClient))
def test__get_api_endpoint():
    api_override = "foo.com"
    mock_client_cert_source = mock.Mock()
    default_universe = StorageClient._DEFAULT_UNIVERSE
    default_endpoint = StorageClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=default_universe)
    mock_universe = "bar.com"
    mock_endpoint = StorageClient._DEFAULT_ENDPOINT_TEMPLATE.format(UNIVERSE_DOMAIN=mock_universe)

    assert StorageClient._get_api_endpoint(api_override, mock_client_cert_source, default_universe, "always") == api_override
    assert StorageClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "auto") == StorageClient.DEFAULT_MTLS_ENDPOINT
    assert StorageClient._get_api_endpoint(None, None, default_universe, "auto") == default_endpoint
    assert StorageClient._get_api_endpoint(None, None, default_universe, "always") == StorageClient.DEFAULT_MTLS_ENDPOINT
    assert StorageClient._get_api_endpoint(None, mock_client_cert_source, default_universe, "always") == StorageClient.DEFAULT_MTLS_ENDPOINT
    assert StorageClient._get_api_endpoint(None, None, mock_universe, "never") == mock_endpoint
    assert StorageClient._get_api_endpoint(None, None, default_universe, "never") == default_endpoint

    with pytest.raises(MutualTLSChannelError) as excinfo:
        StorageClient._get_api_endpoint(None, mock_client_cert_source, mock_universe, "auto")
...
def test__get_universe_domain():
    ...
    assert StorageClient._get_universe_domain(client_universe_domain, universe_domain_env) == client_universe_domain
    assert StorageClient._get_universe_domain(None, universe_domain_env) == universe_domain_env
...
@pytest.mark.parametrize("client_class", [
    StorageClient, StorageAsyncClient
])
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    ...
    (StorageAsyncClient, transports.StorageGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
])
def test_storage_client_client_options_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
...
def test_storage_client_client_options_from_dict():
    with mock.patch('google.cloud.storage_v2.services.storage.transports.StorageGrpcTransport.__init__') as grpc_transport:
...
def test_storage_client_create_channel_credentials_file(client_class, transport_class, transport_name, grpc_helpers):
    # Check the case credentials file is provided.
    options = client_options.ClientOptions(
        credentials_file="credentials.json"
    )
...
@pytest.mark.asyncio
async def test_create_bucket_async(transport: str = 'grpc_asyncio', request_type=storage.CreateBucketRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_list_buckets_async(transport: str = 'grpc_asyncio', request_type=storage.ListBucketsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(storage.ListBucketsResponse(
            next_page_token='next_page_token_value',
            unreachable=['unreachable_value'],
        ))
...
def test_list_buckets_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, storage.Bucket)
                   for i in results)
...
def test_lock_bucket_retention_policy_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.lock_bucket_retention_policy in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.lock_bucket_retention_policy] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_lock_bucket_retention_policy_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.lock_bucket_retention_policy in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.lock_bucket_retention_policy] = mock_rpc
...
@pytest.mark.asyncio
async def test_lock_bucket_retention_policy_async(transport: str = 'grpc_asyncio', request_type=storage.LockBucketRetentionPolicyRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
@pytest.mark.asyncio
async def test_compose_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.compose_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.compose_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_delete_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.delete_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.delete_object] = mock_rpc
...
def test_restore_object(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.restore_object),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage.Object(
            name='name_value',
...
@pytest.mark.asyncio
async def test_restore_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.restore_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.restore_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_restore_object_async(transport: str = 'grpc_asyncio', request_type=storage.RestoreObjectRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_cancel_resumable_write(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.cancel_resumable_write),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_cancel_resumable_write_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.cancel_resumable_write in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.cancel_resumable_write] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_cancel_resumable_write_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.cancel_resumable_write in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.cancel_resumable_write] = mock_rpc
...
@pytest.mark.asyncio
async def test_cancel_resumable_write_async(transport: str = 'grpc_asyncio', request_type=storage.CancelResumableWriteRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
async def test_get_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    ...
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._client._transport.get_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.get_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_read_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.read_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.read_object] = mock_rpc
...
def test_bidi_read_object(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.bidi_read_object),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_bidi_read_object_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.bidi_read_object] = mock_rpc
        request = [{}]
...
@pytest.mark.asyncio
async def test_bidi_read_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.bidi_read_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.bidi_read_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_bidi_read_object_async(transport: str = 'grpc_asyncio', request_type=storage.BidiReadObjectRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        call.return_value.read = mock.AsyncMock(side_effect=[storage.BidiReadObjectResponse()])
...
@pytest.mark.asyncio
async def test_update_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.update_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.update_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_write_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.write_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.write_object] = mock_rpc
...
def test_bidi_write_object(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.bidi_write_object),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_bidi_write_object_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.bidi_write_object] = mock_rpc
        request = [{}]
...
@pytest.mark.asyncio
async def test_bidi_write_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.bidi_write_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.bidi_write_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_bidi_write_object_async(transport: str = 'grpc_asyncio', request_type=storage.BidiWriteObjectRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
    ...
    with mock.patch.object(
        ...
        # Designate an appropriate return value for the call.
        call.return_value = mock.Mock(aio.StreamStreamCall, autospec=True)
        call.return_value.read = mock.AsyncMock(side_effect=[storage.BidiWriteObjectResponse()])
...
@pytest.mark.asyncio
async def test_list_objects_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.list_objects in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.list_objects] = mock_rpc
...
async def test_list_objects_async(transport: str = 'grpc_asyncio', request_type=storage.ListObjectsRequest):
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value =grpc_helpers_async.FakeUnaryUnaryCall(storage.ListObjectsResponse(
            prefixes=['prefixes_value'],
            next_page_token='next_page_token_value',
        ))
...
def test_list_objects_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, storage.Object)
                   for i in results)
...
@pytest.mark.asyncio
async def test_rewrite_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.rewrite_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.rewrite_object] = mock_rpc
...
def test_start_resumable_write_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.start_resumable_write in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.start_resumable_write] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_start_resumable_write_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.start_resumable_write in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.start_resumable_write] = mock_rpc
...
def test_query_write_status_use_cached_wrapped_rpc():
    ...
    with mock.patch("google.api_core.gapic_v1.method.wrap_method") as wrapper_fn:
        ...
        # Ensure method has been cached
        assert client._transport.query_write_status in client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.Mock()
        mock_rpc.return_value.name = "foo" # operation_request.operation in compute client(s) expect a string.
        client._transport._wrapped_methods[client._transport.query_write_status] = mock_rpc
        request = {}
...
@pytest.mark.asyncio
async def test_query_write_status_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.query_write_status in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.query_write_status] = mock_rpc
...
def test_move_object(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.move_object),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = storage.Object(
            name='name_value',
...
@pytest.mark.asyncio
async def test_move_object_async_use_cached_wrapped_rpc(transport: str = "grpc_asyncio"):
    # Clients should use _prep_wrapped_messages to create cached wrapped rpcs,
    # instead of constructing them on each call
    with mock.patch("google.api_core.gapic_v1.method_async.wrap_method") as wrapper_fn:
        client = StorageAsyncClient(
        ...
        # Ensure method has been cached
        assert client._client._transport.move_object in client._client._transport._wrapped_methods

        # Replace cached wrapped function with mock
        mock_rpc = mock.AsyncMock()
        mock_rpc.return_value = mock.Mock()
        client._client._transport._wrapped_methods[client._client._transport.move_object] = mock_rpc
...
@pytest.mark.asyncio
async def test_move_object_async(transport: str = 'grpc_asyncio', request_type=storage.MoveObjectRequest):
    client = StorageAsyncClient(
        credentials=async_anonymous_credentials(),
        transport=transport,
    )
...
def test_compose_object_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
        ...
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = storage.ComposeObjectRequest(**{"destination": {"bucket": "sample1"}})
...
def test_cancel_resumable_write_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = storage.CancelResumableWriteResponse()
        client.cancel_resumable_write(request={"upload_id": "projects/sample1/buckets/sample2/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = storage.CancelResumableWriteRequest(**{"upload_id": "projects/sample1/buckets/sample2/sample3"})
...
def test_start_resumable_write_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = storage.StartResumableWriteResponse()
        client.start_resumable_write(request={"write_object_spec": {"resource": {"bucket": "sample1"}}})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = storage.StartResumableWriteRequest(**{"write_object_spec": {"resource": {"bucket": "sample1"}}})
...
def test_query_write_status_routing_parameters_request_1_grpc():
    ...
    with mock.patch.object(
            ...
            '__call__') as call:
        call.return_value = storage.QueryWriteStatusResponse()
        client.query_write_status(request={"upload_id": "projects/sample1/buckets/sample2/sample3"})

        # Establish that the underlying stub method was called.
        call.assert_called()
        _, args, kw = call.mock_calls[0]
        request_msg = storage.QueryWriteStatusRequest(**{"upload_id": "projects/sample1/buckets/sample2/sample3"})
...
async def test_cancel_resumable_write_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.cancel_resumable_write(request={"upload_id": "projects/sample1/buckets/sample2/sample3"})
...
async def test_start_resumable_write_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.start_resumable_write(request={"write_object_spec": {"resource": {"bucket": "sample1"}}})
...
async def test_query_write_status_routing_parameters_request_1_grpc_asyncio():
    ...
    with mock.patch.object(
        ...
        await client.query_write_status(request={"upload_id": "projects/sample1/buckets/sample2/sample3"})
...
def test_storage_base_transport():
    ...
    with mock.patch('google.cloud.storage_v2.services.storage.transports.StorageTransport.__init__') as Transport:
...
def test_storage_base_transport_with_credentials_file():
    ...
    with mock.patch.object(google.auth, 'load_credentials_from_file', autospec=True) as load_creds, mock.patch('google.cloud.storage_v2.services.storage.transports.StorageTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
...
def test_storage_base_transport_with_adc():
    ...
    with mock.patch.object(google.auth, 'default', autospec=True) as adc, mock.patch('google.cloud.storage_v2.services.storage.transports.StorageTransport._prep_wrapped_messages') as Transport:
        Transport.return_value = None
        adc.return_value = (ga_credentials.AnonymousCredentials(), None)
        transport = transports.StorageTransport()
        adc.assert_called_once()
