...
class storageCallTransformer(cst.CSTTransformer):
    ...
    METHOD_TO_PARAMS: Dict[str, Tuple[str]] = {
        'bidi_read_object': ('read_object_spec', 'read_ranges', ),
        'bidi_write_object': ('write_offset', 'upload_id', 'write_object_spec', 'append_object_spec', 'checksummed_data', 'object_checksums', 'state_lookup', 'flush', 'finish_write', 'common_object_request_params', ),
        ...
        'create_bucket': ('parent', 'bucket_id', 'bucket', 'predefined_acl', 'predefined_default_object_acl', 'enable_object_retention', ),
        ...
        'get_object': ('bucket', 'object_', 'generation', 'soft_deleted', 'if_generation_match', 'if_generation_not_match', 'if_metageneration_match', 'if_metageneration_not_match', 'common_object_request_params', 'read_mask', 'restore_token', ),
        'list_buckets': ('parent', 'page_size', 'page_token', 'prefix', 'read_mask', 'return_partial_success', ),
        'list_objects': ('parent', 'page_size', 'page_token', 'delimiter', 'include_trailing_delimiter', 'prefix', 'versions', 'read_mask', 'lexicographic_start', 'lexicographic_end', 'soft_deleted', 'include_folders_as_prefixes', 'match_glob', 'filter', ),
        'lock_bucket_retention_policy': ('bucket', 'if_metageneration_match', ),
        'move_object': ('bucket', 'source_object', 'destination_object', 'if_source_generation_match', 'if_source_generation_not_match', 'if_source_metageneration_match', 'if_source_metageneration_not_match', 'if_generation_match', 'if_generation_not_match', 'if_metageneration_match', 'if_metageneration_not_match', ),
        ...
        'restore_object': ('bucket', 'object_', 'generation', 'restore_token', 'if_generation_match', 'if_generation_not_match', 'if_metageneration_match', 'if_metageneration_not_match', 'copy_source_acl', 'common_object_request_params', ),
        ...
        'update_object': ('object_', 'update_mask', 'if_generation_match', 'if_generation_not_match', 'if_metageneration_match', 'if_metageneration_not_match', 'predefined_acl', 'common_object_request_params', 'override_unlocked_retention', ),
