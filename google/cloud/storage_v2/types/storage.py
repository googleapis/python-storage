...
class Bucket(proto.Message):
    ...
    class Encryption(proto.Message):
        ...
        class GoogleManagedEncryptionEnforcementConfig(proto.Message):
            ...
            Attributes:
                restricted (bool):
                    Whether Google Managed Encryption (GMEK) is
                    restricted for new objects within the bucket. If
                    true, new objects can't be created using GMEK
                    encryption. If false or unset, creation of new
                    objects with GMEK encryption is allowed.

                    This field is a member of `oneof`_ ``_restricted``.
        ...
        class CustomerManagedEncryptionEnforcementConfig(proto.Message):
            ...
            Attributes:
                restricted (bool):
                    Whether Customer Managed Encryption (CMEK) is
                    restricted for new objects within the bucket. If
                    true, new objects can't be created using CMEK
                    encryption. If false or unset, creation of new
                    objects with CMEK encryption is allowed.
        ...
        class CustomerSuppliedEncryptionEnforcementConfig(proto.Message):
            ...
            Attributes:
                restricted (bool):
                    Whether Customer Supplied Encryption (CSEK)
                    is restricted for new objects within the bucket.
                    If true, new objects can't be created using CSEK
                    encryption. If false or unset, creation of new
                    objects with CSEK encryption is allowed.
